...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _imageLable = [[UIImageView alloc] initWithFrame:CGRectMake(15, 15, 70, 90)];
        
        [_nameLabel setFont:[UIFont fontWithName:@"Arial-BoldMT" size:15]];
        [_subnameLabel setFont:[UIFont fontWithName:@"Arial-BoldMT" size:14]];
